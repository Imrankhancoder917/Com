...
<%@page import="com.shoping.mavenproject7.helper.Helper"%>
<%@page import="java.util.List"%>
<%@page import="com.shoping.mavenproject7.Dao.ProductDao"%>
<%@page import="com.shoping.mavenproject7.Dao.CategoryDao"%>
<%@page import="com.shoping.mavenproject7.entities.Category"%>
...
<head>
    ...
    <title>HobbyLobby - Home</title>
    <%@include file="Component/common_css_js.jsp" %>  <!-- Common CSS & JS -->
    <link rel="stylesheet" href="CSS/home.css"> <!-- Your custom styles -->
</head>
<body>
